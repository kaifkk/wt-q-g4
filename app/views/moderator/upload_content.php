...
unset($_SESSION['mod_content_errors'], $_SESSION['mod_content_success']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Upload Content – MediaFTP Moderator</title>
...
<body>
    ...
    <div class="mod-wrapper">
        ...
        <div class="section-card">
            ...
            <form id="uploadForm"
                  action="../../controllers/moderator/contentController.php"
                  method="POST"
